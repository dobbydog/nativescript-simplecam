...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SimpleCam",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SimpleCam9SimpleCam")
@interface SimpleCam : UIViewController
@property (nonatomic, weak) id <SimpleCamDelegate> _Nullable delegate;
...
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)bundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (void)capturePhoto;
- (BOOL)retakePhoto SWIFT_WARN_UNUSED_RESULT;
...
@interface SimpleCam (SWIFT_EXTENSION(SimpleCam)) <AVCapturePhotoCaptureDelegate>
...
SWIFT_PROTOCOL("_TtP9SimpleCam17SimpleCamDelegate_")
@protocol SimpleCamDelegate
- (void)simpleCamNotAuthorizedForCameraUse:(SimpleCam * _Nonnull)simpleCam;
- (void)simpleCam:(SimpleCam * _Nonnull)simpleCam didFinishWithImage:(UIImage * _Nullable)image;
@optional
- (void)simpleCam:(SimpleCam * _Nonnull)simpleCam didCaptureImage:(UIImage * _Nullable)image;
- (void)simpleCamDidLoadCameraIntoView:(SimpleCam * _Nonnull)simpleCam;
@end
